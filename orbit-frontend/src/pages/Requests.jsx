    ...
    <div className="space-y-6">
      ...
      <div className="flex rounded-lg border border-white/10 bg-white/5 p-1 w-fit">
        ...
        >
          Received{" "}
          {pendingCount > 0 && (
            <span className="ml-1.5 inline-flex size-5 items-center justify-center rounded-full bg-violet-500 text-[10px] text-white">
              {pendingCount}
            </span>
          )}
        </button>
          ...
          {received.length === 0 ? (
            ...
            received.map((req) => (
              ...
              >
                ...
                {req.message && (
                  <p className="mt-2 text-xs text-zinc-400 pl-13">
                    "{req.message}"
                  </p>
                )}
              </div>
