                        ...
                        <form className="p-6 md:p-8">
                            <FieldGroup>
                                ...
                                <Tabs defaultValue="creator" className="w-full " onValueChange={(value) => setRole(value)}>
                                    ...
                                    <TabsContent value="creator" className="mt-4 flex flex-col gap-4">
                                        <Field>
                                            <FieldLabel htmlFor="username">Username</FieldLabel>
                                            <Input id="username" type="text" placeholder="xyz" value={formData.name} required onChange={(e) =>
                                                setFormData({
                                        ...
                                        <Field>
                                            <Field className="grid grid-cols-2 gap-4">
                                                ...
                                                <Field>
                                                    ...
                                                    <Input id="confirm-password" type="password" required value={formData.confirmPass}
