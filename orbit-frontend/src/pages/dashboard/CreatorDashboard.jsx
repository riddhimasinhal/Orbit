        ...
        return (
            <div className="space-y-4">
                ...
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-8 text-center">
                    ...
                    <Link to="/creator-onboarding" className="inline-block mt-3 text-sm text-violet-400 hover:text-violet-300">Complete Onboarding →</Link>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-zinc-500 mt-1">Here's an overview of your creator profile.</p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
                    ...
                    <p className="text-xl font-semibold text-white">{formatNum(profile?.instagramFollowers)}</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-xl font-semibold text-white">{formatNum(profile?.youtubeSubscribers)}</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-xl font-semibold text-white">{formatNum(profile?.averageViews)}</p>
                </div>
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-xl font-semibold text-white">{profile?.niche?.length ? profile.niche.join(", ") : "—"}</p>
                </div>
            </div>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6">
                    <h2 className="text-sm font-medium text-zinc-300 mb-4">Profile Info</h2>
                    <div className="space-y-3">
                        <div className="flex justify-between">
                            <span className="text-sm text-zinc-500">Full Name</span>
                            <span className="text-sm text-white">{profile?.fullName || "Not set"}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm text-zinc-500">Username</span>
                            <span className="text-sm text-white">{profile?.username || "Not set"}</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className="text-sm text-white">{profile?.audienceCountry || "Not set"}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6">
                    ...
                    <div className="space-y-3">
                        <div className="flex justify-between">
                            ...
                            <span className="text-sm text-violet-400">{profile?.instagramUsername ? `@${profile.instagramUsername}` : "Not linked"}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm text-zinc-500">YouTube</span>
                            <span className="text-sm text-violet-400 truncate max-w-[200px]">{profile?.youtubeUrl || "Not linked"}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm text-zinc-500">LinkedIn</span>
                            <span className="text-sm text-violet-400 truncate max-w-[200px]">{profile?.linkedInUrl || "Not linked"}</span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-sm text-zinc-500">Portfolio</span>
                            <span className="text-sm text-violet-400 truncate max-w-[200px]">{profile?.portfolioUrl || "Not linked"}</span>
                        </div>
                    </div>
                </div>
            </div>
