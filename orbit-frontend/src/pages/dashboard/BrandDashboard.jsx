    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-500 mt-1">
          Here's an overview of your brand profile.
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
          ...
          <p className="text-xl font-semibold text-white">
            {profile?.preferredNiche?.length
              ? profile.preferredNiche.join(", ")
              : "—"}
          </p>
        </div>
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
        ...
        <div className="rounded-xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-sm text-violet-400">
                {profile?.instagramPage || "Not linked"}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-zinc-500">LinkedIn</span>
              <span className="text-sm text-violet-400">
                {profile?.linkedInPage || "Not linked"}
              </span>
            </div>
          </div>
        </div>
